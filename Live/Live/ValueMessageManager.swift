...
class ValueMessageManager: MessageManager {
    ...
    init() {
        ...
        messages = [
            ...
            Message(group: independence, identifier: "18", string: "Think about the self-respect that your independence gave you."),
            ...
            Message(group: politics, identifier: "1", string: "Think about choices politicians have made."),
            ...
            Message(group: politics, identifier: "16", string: "Think about learning about the news online."),
            ...
            Message(group: spirituality, identifier: "3", string: "Think about being blessed by a spiritual connection."),
            ...
            Message(group: spirituality, identifier: "10", string: "Think about having spiritual values that offer you moral guidance."),
            Message(group: spirituality, identifier: "11", string: "Think about having spiritual values that help you feel fulfilled."),
            Message(group: spirituality, identifier: "12", string: "Think about having spiritual values that help you deal with stress."),
            Message(group: spirituality, identifier: "13", string: "Think about connecting with spiritual values to feel energized."),
            Message(group: spirituality, identifier: "14", string: "Think about how having spiritual values gives you a purpose in life."),
            Message(group: spirituality, identifier: "15", string: "Think about using meditation or prayer to achieve a spiritual connection."),
            Message(group: spirituality, identifier: "16", string: "Think about meditating and feeling connected to the world."),
            ...
            Message(group: humor, identifier: "14", string: "Think about connecting with someone else when you shared a laugh."),
            ...
            Message(group: fame, identifier: "10", string: "Think about being popular and having people want to talk to you."),
            ...
            Message(group: powerAndStatus, identifier: "8", string: "Think about having high social status and having people take your opinions seriously."),
            ...
            Message(group: powerAndStatus, identifier: "13", string: "Think about serving in a leadership role and having people listen to you."),
            ...
            Message(group: familyAndFriends, identifier: "12", string: "Think about feeling like you belong to a family or friendship."),
            ...
            Message(group: familyAndFriends, identifier: "16", string: "Think about having a connection with your friends and family."),
            Message(group: familyAndFriends, identifier: "17", string: "Think about sharing life experiences with your friends and family."),
            Message(group: familyAndFriends, identifier: "18", string: "Think about belonging to a family or friendship."),
            ...
            Message(group: compassionAndKindness, identifier: "2", string: "Think about comforting and cheering up someone who is feeling sad."),
            ...
            Message(group: compassionAndKindness, identifier: "5", string: "Think about helping someone who is in trouble without expecting anything in return."),
            Message(group: compassionAndKindness, identifier: "6", string: "Think about allowing others to be themselves in your presence."),
            Message(group: compassionAndKindness, identifier: "7", string: "Think about accepting and being understanding of others' weaknesses."),
            ...
            Message(group: compassionAndKindness, identifier: "16", string: "Think about letting go of a grudge and forgiving."),
            Message(group: compassionAndKindness, identifier: "17", string: "Think about feeling sorry and caring for others in tough situations."),
